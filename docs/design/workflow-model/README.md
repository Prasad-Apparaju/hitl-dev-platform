...
| [01-design.md](01-design.md) | The **structure**, hierarchy, numberless catalog + derived numbering, the two workflow families, the taxonomy + full tree, step→command/role + coverage audit, the phase-ribbon breadcrumb, the change-file impact, and the citation convention. |
