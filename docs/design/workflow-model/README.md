...
| Doc | What it covers |
|---|---|
| [../../01-product/workflow-model/requirements.md](../../01-product/workflow-model/requirements.md) (the *what*) | The problem (number staleness, command/process conflation), the workflow contract, goals, constraints, non-goals. |
