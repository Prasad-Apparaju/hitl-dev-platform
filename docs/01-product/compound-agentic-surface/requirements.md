...
> [`03-lld.md`](../../design/compound-agentic-surface/03-lld.md) **v3.3** — design review concluded
> 2026-07-23 (Codex rounds 1–12). FR-26 ⇄ this doc are cross-linked; §7 traces every `CR-n` to a sub-issue.
