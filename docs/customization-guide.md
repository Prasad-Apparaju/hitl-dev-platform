...
| `/hitl:apply-change` | `ai/claude/apply-change/SKILL.md` |
| `/hitl:check-conventions` | `ai/claude/check-conventions/SKILL.md` |
| `/hitl:impact-brief` | `ai/claude/impact-brief/SKILL.md` |
| `/hitl:tdd` | `ai/claude/tdd/SKILL.md` |
| `/hitl:generate-docs` | `ai/claude/generate-docs/SKILL.md` |
| `/hitl:conclude` | `ai/claude/conclude/SKILL.md` |
...
| `/hitl:ops-plan-platform` | `ai/claude/ops/plan-platform/SKILL.md` |
