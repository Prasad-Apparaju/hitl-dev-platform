...
| I want to... | Command |
|---|---|
| Check what's been built | `/hitl:pm:review-progress` |
| Design a feature from scratch | `/hitl:pm:design-feature [idea]` |
| Add a quick requirement | `/hitl:pm:add-feature [description]` |
| Update a requirement | `/hitl:pm:update-requirement [FR-ID] [change]` |
