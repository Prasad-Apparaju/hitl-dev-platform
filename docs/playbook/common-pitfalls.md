...
Not every change needs the full workflow. Use this table to decide the right process weight. **The full 32-step workflow is for Tier 3.** Most routine work is Tier 1 or Tier 2.
