...
This is enforced by the development workflow (see [dev-practices](../../ai/claude/dev-practices/SKILL.md)). The combination of issue linkage and co-author trailer makes it possible to trace any line of code back to the decision that produced it and know whether AI was involved.
