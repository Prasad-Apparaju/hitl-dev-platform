...
Architectural trade-offs, PRD scope changes, and cross-team decisions → discuss with the technical advisor and product owner using the prescribed documentation formats. See [Architect Playbook — Escalation Path](../../shared/templates/architect-playbook.md#escalation-path).
