...
|---|---|
| `CLAUDE.md` | 32-step workflow, preflight check, coding standards, cross-cutting conventions |
...
| I need to... | Go to... |
|---|---|
| Understand the 32-step workflow | `CLAUDE.md` (inlined) or `docs/playbook/process-overview.md` (visual) |
