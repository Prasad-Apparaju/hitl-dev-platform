...
See `templates/test-registry-template.yaml` for the full format with examples.
...
See `templates/incident-registry-template.yaml` for the full format with examples.
