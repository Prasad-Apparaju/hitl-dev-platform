...
To customize a command, edit its `SKILL.md`. Note: `agents/`, `commands/`, and `hooks/` are subdirectories inside `ai/` — they are part of the same AI runtime. Changes take effect on the next Claude Code session.
