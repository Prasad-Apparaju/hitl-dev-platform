...
Hooks fire at Claude Code events (PreToolUse, PostToolUse) to enforce HITL requirements in real time, before a tool call completes. Registered via `.claude-plugin/plugin.json` in the installed plugin.
