...
- Agentic observability: copy `shared/templates/token-cost-registry-template.yaml` to `docs/04-operations/token-cost-registry.yaml`; session logs are written automatically by the HITL hooks
