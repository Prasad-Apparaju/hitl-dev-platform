...
Generate `docs/system-manifest.yaml` from the confirmed domain breakdown. Follow the schema in `claude/generate-docs/templates/system-manifest.schema.yaml`.
